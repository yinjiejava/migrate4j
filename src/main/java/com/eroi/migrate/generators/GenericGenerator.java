...
public class GenericGenerator implements Generator {
	...
	public boolean columnExists(String columnName, String tableName) {
		...
		try {
			...
			log.error("Exception occoured in GenericGenerator.columnExists(Column, Table)!!", exception);
	...
	public boolean foreignKeyExists(String foreignKeyName, String childTableName) {
		...
		try {
            ...
            log.error("Error occoured in GenericGenerator.foreignKeyExists(foreignKeyName, childTableName)",
            		exception);
	...
	public boolean hasPrimaryKey(String tableName) {
		...
		try {
			...
			log.error("Exception occoured in GenericGenerator.hasPrimaryKey(tableName)!!", exception);
			throw new SchemaMigrationException(exception);
		}
	}
	...
	public boolean isPrimaryKey(String columnName, String tableName) {
		...
		try {
			...
			log.error("Exception occoured in GenericGenerator.isPrimaryKey(columnName, tableName)!!",
					exception);
